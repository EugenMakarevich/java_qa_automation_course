...
public class ContactCreationTests {
  ...
  private void fillContactForm() {
    ...
    wd.findElement(By.name("address")).sendKeys("www leningrad");
    ...
    wd.findElement(By.name("mobile")).sendKeys("+48123456789");
    wd.findElement(By.name("email")).click();
    wd.findElement(By.name("email")).clear();
    wd.findElement(By.name("email")).sendKeys("vasyapupkin@gmail.com");
  }
